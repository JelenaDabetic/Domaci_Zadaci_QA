...
Kreirati apstraktnu klasu Control koja ima:
 apstraktnu metodu izvrsi akciju, koja kao parametar prima
 objekat VideoPlayer
Kreirati klasu TimeControl koja nasledjuje klasu Control
i konstruktore, ima atribut koji kaze na koju stranu pomera
 trenutno vreme videa (tipa boolean), implementira metodu
  izvrsi akciju tako sto pomeri trenutno vreme videa za
	15s unapred ili unazad u zavisnosti od atributa. Veoma
	je bitno da se ne izadje van granica videa.
...
Kreirati klasu QualityOptimizerControl koja nasledjuje
klasu Control i ima brzinu interneta u megabitima npr
10mb/s 20mb/s... Getere, setere i konstruktore.
Implementira metodu izvrsi akciju tako sto postavlja
kvalitet videa u zavisnosti od brzine interneta.
 Kvalitet se racuna na osnovu formule: brzina
 interneta * 10.1 gde se uzima prvi veci kvalitet
